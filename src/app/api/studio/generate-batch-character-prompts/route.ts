...
import { generateBatchCharacterPrompts } from "@/modules/studio/application/use-cases/generate-batch-character-prompts";
...
export async function POST(request: NextRequest) {
  try {
    ...
    const result = await generateBatchCharacterPrompts(assets, projectInfo);
